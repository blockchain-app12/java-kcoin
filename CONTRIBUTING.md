# Contributing to java-kcoin

java-kcoin is an open source project.
...
First of all, java-kcoin follows GitFlow, the branches description in the java-kcoin project are listed as follow:
...
If you'd like to contribute to java-kcoin, you should follow the steps below:
- **Fork** a repository from **kcoinprotocol/java-kcoin** allows you to freely experiment with changes without affecting the original project
...
- **Send** a Pull Request（PR）for the maintainers to review and merge into the main code base.
  *notice*：When you create a new PR，please choose the **kcoinprotocol/java-kcoin** as the base repository and choose **your fork/java-kcoin** as the head repository.
...
we will close the PR and merge into the protocol/java-kcoin's develop branch.
...
issue](https://github.com/kcoinprotocol/java-kcoin/issues) before anyone
...
Bonus point applies in KCOIN incentives programme. Developers can earn points by contributing to KCOIN.

You can find your points ranking at  [Kcoinscan](https://kcoinscan.org/#/developersreward).

The Top 5 scored developers (for every month, quarter and year) can win a cash reward.

For more details, please visit [Incentives Policy](https://kcoinprotocol.github.io/documentation-en/developers/incentives/).
