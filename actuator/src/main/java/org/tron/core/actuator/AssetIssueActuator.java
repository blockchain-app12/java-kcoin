...
public class AssetIssueActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (dynamicStore.getAllowSameTokenName() != 0) {
      ...
      if (("sym").equals(name)) {
        throw new ContractValidateException("assetName can't be sym");
      }
    }
    ...
    if (assetIssueContract.getSymNum() <= 0) {
      throw new ContractValidateException("SymNum must greater than 0!");
    }
