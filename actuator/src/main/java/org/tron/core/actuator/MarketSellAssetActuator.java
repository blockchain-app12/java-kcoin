...
import static org.kcoin.core.actuator.ActuatorConstant.CONTRACT_NOT_EXIST;
import static org.kcoin.core.actuator.ActuatorConstant.STORE_NOT_EXIST;
import static org.kcoin.core.actuator.ActuatorConstant.TX_RESULT_NULL;
import static org.kcoin.core.capsule.utils.TransactionUtil.isNumber;
...
import org.kcoin.protos.Protocol.MarketOrder.State;
import org.kcoin.protos.Protocol.MarketOrderDetail;
...
public class MarketSellAssetActuator extends AbstractActuator {
  ...
  private void matchSingleOrder(MarketOrderCapsule takerOrderCapsule,
    ...
    // for makerPrice,sellToken is A,buyToken is SYM.
    // for takerPrice,buyToken is A,sellToken is SYM.

    // makerSellTokenQuantity_A/makerBuyTokenQuantity_SYM =
    //   takerBuyTokenQuantityCurrent_A/takerSellTokenQuantityRemain_SYM
    // => takerBuyTokenQuantityCurrent_A = takerSellTokenQuantityRemain_SYM *
    //   makerSellTokenQuantity_A/makerBuyTokenQuantity_SYM
    ...
    if (takerBuyTokenQuantityRemain == makerOrderCapsule.getSellTokenQuantityRemain()) {
      ...
      // makerSellTokenQuantityRemain_A/makerBuyTokenQuantityCurrent_SYM =
      //   makerSellTokenQuantity_A/makerBuyTokenQuantity_SYM
      // => makerBuyTokenQuantityCurrent_SYM = makerSellTokenQuantityRemain_A *
      //   makerBuyTokenQuantity_SYM / makerSellTokenQuantity_A
    ...
    addSymOrToken(takerOrderCapsule, takerBuyTokenQuantityReceive, takerAccountCapsule);
    addSymOrToken(makerOrderCapsule, makerBuyTokenQuantityReceive);
  ...
  // for taker
  private void addSymOrToken(MarketOrderCapsule orderCapsule, long num,
