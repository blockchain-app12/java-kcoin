...
import org.kcoin.core.config.Parameter.ForkBlockVersionEnum;
...
//      }
  ...
  public enum ProposalType {         // current value, value range
    ...
    ACCOUNT_UPGRADE_COST(1), // 9999 SYM, [0, 100000000000] SYM
    CREATE_ACCOUNT_FEE(2), // 0.1 SYM, [0, 100000000000] SYM
    TRANSACTION_FEE(3), // 10 Sun/Byte, [0, 100000000000] SYM
    ASSET_ISSUE_FEE(4), // 1024 SYM, [0, 100000000000] SYM
    WITNESS_PAY_PER_BLOCK(5), // 16 SYM, [0, 100000000000] SYM
    WITNESS_STANDBY_ALLOWANCE(6), // 115200 SYM, [0, 100000000000] SYM
    CREATE_NEW_ACCOUNT_FEE_IN_SYSTEM_CONTRACT(7), // 0 SYM, [0, 100000000000] SYM
    ...
    ENERGY_FEE(11), // 10 Sun, [0, 100000000000] SYM
    EXCHANGE_CREATE_FEE(12), // 1024 SYM, [0, 100000000000] SYM
    ...
    UPDATE_ACCOUNT_PERMISSION_FEE(22), // 100 SYM, [0, 100000] SYM
    MULTI_SIGN_FEE(23), // 1 SYM, [0, 100000] SYM
