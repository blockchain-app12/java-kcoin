...
import static org.kcoin.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.kcoin.core.db.TransactionTrace.convertToKcoinAddress;
import static org.kcoin.core.vm.OpCode.CALL;
import static org.kcoin.core.vm.OpCode.CALLTOKEN;
import static org.kcoin.core.vm.OpCode.CALLTOKENID;
import static org.kcoin.core.vm.OpCode.CALLTOKENVALUE;
import static org.kcoin.core.vm.OpCode.CHAINID;
import static org.kcoin.core.vm.OpCode.CREATE2;
import static org.kcoin.core.vm.OpCode.EXTCODEHASH;
import static org.kcoin.core.vm.OpCode.FREEZE;
import static org.kcoin.core.vm.OpCode.FREEZEEXPIRETIME;
import static org.kcoin.core.vm.OpCode.ISCONTRACT;
import static org.kcoin.core.vm.OpCode.PUSH1;
import static org.kcoin.core.vm.OpCode.REVERT;
import static org.kcoin.core.vm.OpCode.SAR;
import static org.kcoin.core.vm.OpCode.SELFBALANCE;
import static org.kcoin.core.vm.OpCode.SHL;
import static org.kcoin.core.vm.OpCode.SHR;
import static org.kcoin.core.vm.OpCode.TOKENBALANCE;
import static org.kcoin.core.vm.OpCode.UNFREEZE;
import static org.kcoin.core.vm.OpCode.VOTEWITNESS;
import static org.kcoin.core.vm.OpCode.WITHDRAWREWARD;
...
import org.kcoin.core.vm.program.Stack;
...
public class VM {
  ...
  private boolean isDeadAccount(Program program, DataWord address) {
    return program.getContractState().getAccount(convertToKcoinAddress(address.getLast20Bytes()))
        == null;
  }
}
