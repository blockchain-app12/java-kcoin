 ...
 */
package org.kcoin.core.vm.program.invoke;
...
import static org.kcoin.common.utils.WalletUtil.generateContractAddress;
...
public class ProgramInvokeFactoryImpl implements ProgramInvokeFactory {
  ...
  @Override
  public ProgramInvoke createProgramInvoke(InternalTransaction.SymType symType,
    ...
    if (symType == SYM_CONTRACT_CREATION_TYPE) {
    ...
    } else if (symType == SYM_CONTRACT_CALL_TYPE) {
