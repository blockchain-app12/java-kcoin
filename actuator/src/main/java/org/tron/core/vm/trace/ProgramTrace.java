 ...
 */
package org.kcoin.core.vm.trace;
...
import static org.kcoin.core.vm.trace.Serializers.serializeFieldsOnly;
...
public class ProgramTrace {
  ...
  public ProgramTrace(VMConfig config, ProgramInvoke programInvoke) {
    if (programInvoke != null && config.vmTrace()) {
      contractAddress = Hex
          .toHexString(convertToKcoinAddress(programInvoke.getContractAddress().getLast20Bytes()));
    }
  }
