package org.kcoin.common.utils;
...
import org.kcoin.protos.contract.SmartContractOuterClass.SmartContract.ABI.Entry.StateMutabilityType;
...
public class WalletUtil {
  ...
  public static byte[] generateContractAddress(Transaction sym) {
    ...
    byte[] txRawDataHash = symCap.getTransactionId().getBytes();
