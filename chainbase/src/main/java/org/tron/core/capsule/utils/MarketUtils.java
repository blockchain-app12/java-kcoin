...
import org.kcoin.core.capsule.MarketPriceCapsule;
...
public class MarketUtils {
  ...
  /**
   * ex.
   * for sellToken is A, buyToken is SYM.
   * price_A_maker * sellQuantity_maker = Price_SYM * buyQuantity_maker
   * ==> price_A_maker = Price_SYM * buyQuantity_maker/sellQuantity_maker
   *
  ...
  public static boolean priceMatch(MarketPrice takerPrice, MarketPrice makerPrice) {
    ...
    // price_A_taker * buyQuantity_taker = Price_SYM * sellQuantity_taker
    // ==> price_A_taker = Price_SYM * sellQuantity_taker/buyQuantity_taker

    // price_A_taker must be greater or equal to price_A_maker
    // price_A_taker / price_A_maker >= 1
    // ==> Price_SYM * sellQuantity_taker/buyQuantity_taker >= Price_SYM * buyQuantity_maker/sellQuantity_maker
