...
import org.kcoin.core.config.Parameter.AdaptiveResourceLimitConstants;
...
public class EnergyProcessor extends ResourceProcessor {
  ...
  @Override
  public void consume(TransactionCapsule sym,
  ...
  public long calculateGlobalEnergyLimit(AccountCapsule accountCapsule) {
    ...
    long energyWeight = frozeBalance / SYM_PRECISION;
