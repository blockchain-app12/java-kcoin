...
import org.kcoin.common.storage.leveldb.LevelDbDataSourceImpl;
import org.kcoin.common.storage.rocksdb.RocksDbDataSourceImpl;
import org.kcoin.common.utils.StorageUtils;
import org.kcoin.core.capsule.ProtoCapsule;
import org.kcoin.core.db.common.iterator.DBIterator;
import org.kcoin.core.db2.common.DB;
import org.kcoin.core.db2.common.IRevokingDB;
import org.kcoin.core.db2.common.LevelDB;
import org.kcoin.core.db2.common.RocksDB;
import org.kcoin.core.db2.core.Chainbase;
import org.kcoin.core.db2.core.IKcoinChainBase;
import org.kcoin.core.db2.core.RevokingDBWithCachingOldValue;
...
@Slf4j(topic = "DB")
public abstract class KcoinStoreWithRevoking<T extends ProtoCapsule> implements IKcoinChainBase<T> {
  ...
  protected KcoinStoreWithRevoking(String dbName) {
  ...
  protected KcoinStoreWithRevoking(DB<byte[], byte[]> db) {
    int dbVersion = CommonParameter.getInstance().getStorage().getDbVersion();
    if (dbVersion == 2) {
  ...
  // only for test
  protected KcoinStoreWithRevoking(String dbName, RevokingDatabase revokingDatabase) {
    this.revokingDB = new RevokingDBWithCachingOldValue(dbName,
        (AbstractRevokingStore) revokingDatabase);
  }

  // only for test
  protected KcoinStoreWithRevoking(String dbName, Options options,
