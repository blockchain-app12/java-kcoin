...
import org.kcoin.protos.Protocol.AccountAsset;
import org.kcoin.protos.contract.BalanceContract.TransactionBalanceTrace;
import org.kcoin.protos.contract.BalanceContract.TransactionBalanceTrace.Operation;
...
@Slf4j(topic = "DB")
@Component
public class AccountStore extends KcoinStoreWithRevoking<AccountCapsule> {
