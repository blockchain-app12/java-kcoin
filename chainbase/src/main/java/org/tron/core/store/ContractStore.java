...
@Slf4j(topic = "DB")
@Component
public class ContractStore extends KcoinStoreWithRevoking<ContractCapsule> {
   ...
   */
  public byte[] findContractByHash(byte[] symHash) {
    return revokingDB.getUnchecked(symHash);
  }
