package org.kcoin.common.parameter;
...
import org.kcoin.core.config.args.Overlay;
import org.kcoin.core.config.args.SeedNode;
import org.kcoin.core.config.args.Storage;
...
public class CommonParameter {
  ...
  @Parameter(names = {"--contract-parse-enable"},
      description = "enable contract parses in java-kcoin or not.(true or false)")
  ...
  //If you are running a solidity node for java kcoin, this flag is set to true
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public long netMaxSymPerSecond;
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public String symReferenceBlock;
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public long symExpirationTimeInMilliseconds; // (ms)
