...
public class Constant {
  ...
  public static final long SUN_PER_ENERGY = 100; // 1 us = 100 SUN = 100 * 10^-6 SYM
  ...
  public static final byte[] ZKCOIN_EXPANDSEED_PERSONALIZATION = {'Z', 't', 'r', 'o', 'n', '_', 'E',
      'x',
      'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
  ...
  public static final String NODE_NET_MAX_SYM_PER_SECOND = "node.netMaxSymPerSecond";
  ...
  public static final String SYM_REFERENCE_BLOCK = "sym.reference.block";

  public static final String SYM_EXPIRATION_TIME_IN_MILLIS_SECONDS = "sym.expiration.timeInMilliseconds";
