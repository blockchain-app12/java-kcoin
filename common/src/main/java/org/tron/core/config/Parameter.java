...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] SYM_SYMBOL_BYTES = "_".getBytes(); // SYM symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final long SYM_PRECISION = 1000_000L;
  }
