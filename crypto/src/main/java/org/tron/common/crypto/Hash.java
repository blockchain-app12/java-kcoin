...
import static org.kcoin.common.utils.ByteUtil.isNullOrZeroArray;
import static org.kcoin.common.utils.ByteUtil.isSingleZero;
...
public class Hash {
  ...
  static {
    Security.addProvider(KcoinCastleProvider.getInstance());
    CRYPTO_PROVIDER = Security.getProvider("BC");
    HASH_256_ALGORITHM_NAME = "KCOIN-KECCAK-256";
    HASH_512_ALGORITHM_NAME = "KCOIN-KECCAK-512";
