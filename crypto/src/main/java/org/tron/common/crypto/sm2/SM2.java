package org.kcoin.common.crypto.sm2;

import static org.kcoin.common.crypto.Hash.computeAddress;
import static org.kcoin.common.utils.BIUtil.isLessThan;
import static org.kcoin.common.utils.ByteUtil.bigIntegerToBytes;
...
import org.kcoin.common.crypto.jce.ECKeyFactory;
import org.kcoin.common.crypto.jce.KcoinCastleProvider;
...
public class SM2 implements Serializable, SignInterface {
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(KcoinCastleProvider.getInstance())
