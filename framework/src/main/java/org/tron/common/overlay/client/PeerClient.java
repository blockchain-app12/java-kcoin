...
import org.kcoin.common.overlay.server.KcoinChannelInitializer;
...
public class PeerClient {
  ...
  public PeerClient() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "KcoinJClientWorker-" + cnt.getAndIncrement());
      }
    });
  }
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    KcoinChannelInitializer kcoinChannelInitializer = ctx
        .getBean(KcoinChannelInitializer.class, remoteId);
    kcoinChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(kcoinChannelInitializer);
