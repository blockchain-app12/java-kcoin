...
import static org.kcoin.common.utils.Commons.getAssetIssueStoreFinal;
import static org.kcoin.common.utils.Commons.getExchangeStoreFinal;
import static org.kcoin.common.utils.WalletUtil.isConstant;
...
import static org.kcoin.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.kcoin.core.config.Parameter.DatabaseConstants.MARKET_COUNT_LIMIT_MAX;
import static org.kcoin.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
import org.kcoin.api.GrpcAPI.AccountNetMessage;
import org.kcoin.api.GrpcAPI.AccountResourceMessage;
import org.kcoin.api.GrpcAPI.Address;
import org.kcoin.api.GrpcAPI.AssetIssueList;
import org.kcoin.api.GrpcAPI.BlockList;
import org.kcoin.api.GrpcAPI.BytesMessage;
import org.kcoin.api.GrpcAPI.DecryptNotes;
import org.kcoin.api.GrpcAPI.DecryptNotes.NoteTx;
import org.kcoin.api.GrpcAPI.DecryptNotesTRC20;
import org.kcoin.api.GrpcAPI.DelegatedResourceList;
import org.kcoin.api.GrpcAPI.DiversifierMessage;
import org.kcoin.api.GrpcAPI.ExchangeList;
import org.kcoin.api.GrpcAPI.ExpandedSpendingKeyMessage;
import org.kcoin.api.GrpcAPI.IncomingViewingKeyMessage;
import org.kcoin.api.GrpcAPI.NfParameters;
import org.kcoin.api.GrpcAPI.NfTRC20Parameters;
import org.kcoin.api.GrpcAPI.Node;
import org.kcoin.api.GrpcAPI.NodeList;
import org.kcoin.api.GrpcAPI.NoteParameters;
import org.kcoin.api.GrpcAPI.NumberMessage;
import org.kcoin.api.GrpcAPI.PaymentAddressMessage;
import org.kcoin.api.GrpcAPI.PrivateParameters;
import org.kcoin.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.kcoin.api.GrpcAPI.PrivateShieldedTRC20Parameters;
import org.kcoin.api.GrpcAPI.PrivateShieldedTRC20ParametersWithoutAsk;
import org.kcoin.api.GrpcAPI.ProposalList;
import org.kcoin.api.GrpcAPI.ReceiveNote;
import org.kcoin.api.GrpcAPI.Return;
import org.kcoin.api.GrpcAPI.Return.response_code;
import org.kcoin.api.GrpcAPI.ShieldedAddressInfo;
import org.kcoin.api.GrpcAPI.ShieldedTRC20Parameters;
import org.kcoin.api.GrpcAPI.ShieldedTRC20TriggerContractParameters;
import org.kcoin.api.GrpcAPI.SpendAuthSigParameters;
import org.kcoin.api.GrpcAPI.SpendNote;
import org.kcoin.api.GrpcAPI.SpendResult;
import org.kcoin.api.GrpcAPI.TransactionApprovedList;
import org.kcoin.api.GrpcAPI.TransactionExtention;
import org.kcoin.api.GrpcAPI.TransactionExtention.Builder;
import org.kcoin.api.GrpcAPI.TransactionInfoList;
import org.kcoin.api.GrpcAPI.WitnessList;
import org.kcoin.common.crypto.Hash;
import org.kcoin.common.crypto.SignInterface;
import org.kcoin.common.crypto.SignUtils;
import org.kcoin.common.overlay.discover.node.NodeHandler;
...
import org.kcoin.common.zksnark.IncrementalMerkleTreeContainer;
import org.kcoin.common.zksnark.IncrementalMerkleVoucherContainer;
import org.kcoin.common.zksnark.JLibrustzcash;
import org.kcoin.common.zksnark.LibrustzcashParam.ComputeNfParams;
import org.kcoin.common.zksnark.LibrustzcashParam.CrhIvkParams;
import org.kcoin.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.kcoin.common.zksnark.LibrustzcashParam.SpendSigParams;
import org.kcoin.consensus.ConsensusDelegate;
import org.kcoin.core.actuator.Actuator;
import org.kcoin.core.actuator.ActuatorFactory;
...
import org.kcoin.core.capsule.BlockBalanceTraceCapsule;
...
import org.kcoin.core.capsule.DelegatedResourceAccountIndexCapsule;
import org.kcoin.core.capsule.DelegatedResourceCapsule;
import org.kcoin.core.capsule.ExchangeCapsule;
import org.kcoin.core.capsule.IncrementalMerkleTreeCapsule;
import org.kcoin.core.capsule.IncrementalMerkleVoucherCapsule;
...
import org.kcoin.core.capsule.PedersenHashCapsule;
...
import org.kcoin.core.db.BandwidthProcessor;
import org.kcoin.core.db.BlockIndexStore;
import org.kcoin.core.db.EnergyProcessor;
import org.kcoin.core.db.Manager;
import org.kcoin.core.db.TransactionContext;
import org.kcoin.core.exception.AccountResourceInsufficientException;
...
import org.kcoin.core.exception.DupTransactionException;
import org.kcoin.core.exception.HeaderNotFound;
import org.kcoin.core.exception.ItemNotFoundException;
import org.kcoin.core.exception.NonUniqueObjectException;
import org.kcoin.core.exception.PermissionException;
import org.kcoin.core.exception.SignatureFormatException;
import org.kcoin.core.exception.StoreException;
import org.kcoin.core.exception.TaposException;
import org.kcoin.core.exception.TooBigTransactionException;
import org.kcoin.core.exception.TransactionExpirationException;
import org.kcoin.core.exception.VMIllegalException;
import org.kcoin.core.exception.ValidateSignatureException;
...
import org.kcoin.core.zen.ShieldedTRC20ParametersBuilder;
import org.kcoin.core.zen.ShieldedTRC20ParametersBuilder.ShieldedTRC20ParametersType;
import org.kcoin.core.zen.ZenTransactionBuilder;
import org.kcoin.core.zen.address.DiversifierT;
import org.kcoin.core.zen.address.ExpandedSpendingKey;
import org.kcoin.core.zen.address.IncomingViewingKey;
import org.kcoin.core.zen.address.KeyIo;
import org.kcoin.core.zen.address.PaymentAddress;
import org.kcoin.core.zen.address.SpendingKey;
import org.kcoin.core.zen.note.Note;
import org.kcoin.core.zen.note.NoteEncryption;
import org.kcoin.core.zen.note.NoteEncryption.Encryption;
import org.kcoin.core.zen.note.OutgoingPlaintext;
import org.kcoin.protos.Protocol;
import org.kcoin.protos.Protocol.Account;
import org.kcoin.protos.Protocol.Block;
import org.kcoin.protos.Protocol.DelegatedResourceAccountIndex;
...
import org.kcoin.protos.Protocol.MarketPrice;
import org.kcoin.protos.Protocol.MarketPriceList;
import org.kcoin.protos.Protocol.Proposal;
...
import org.kcoin.protos.contract.BalanceContract.BlockBalanceTrace;
import org.kcoin.protos.contract.BalanceContract.TransferContract;
import org.kcoin.protos.contract.ShieldContract.IncrementalMerkleTree;
import org.kcoin.protos.contract.ShieldContract.IncrementalMerkleVoucherInfo;
import org.kcoin.protos.contract.ShieldContract.OutputPoint;
import org.kcoin.protos.contract.ShieldContract.OutputPointInfo;
import org.kcoin.protos.contract.ShieldContract.PedersenHash;
import org.kcoin.protos.contract.ShieldContract.ReceiveDescription;
import org.kcoin.protos.contract.ShieldContract.ShieldedTransferContract;
import org.kcoin.protos.contract.SmartContractOuterClass.CreateSmartContract;
import org.kcoin.protos.contract.SmartContractOuterClass.SmartContract;
import org.kcoin.protos.contract.SmartContractOuterClass.SmartContractDataWrapper;
...
public class Wallet {
  ...
  private void setTransaction(TransactionCapsule sym) {
    try {
      BlockId blockId = chainBaseManager.getHeadBlockId();
      if ("solid".equals(Args.getInstance().getSymReferenceBlock())) {
        blockId = chainBaseManager.getSolidBlockId();
      }
      sym.setReference(blockId.getNum(), blockId.getBytes());
      long expiration = chainBaseManager.getHeadBlockTimeStamp() + Args.getInstance()
          .getSymExpirationTimeInMilliseconds();
      sym.setExpiration(expiration);
      sym.setTimestamp();
    } catch (Exception e) {
  ...
  private TransactionCapsule createTransactionCapsuleWithoutValidateWithTimeout(
      ...
      long timeout) {
    TransactionCapsule sym = new TransactionCapsule(message, contractType);
    try {
      BlockId blockId = chainBaseManager.getHeadBlockId();
      if ("solid".equals(Args.getInstance().getSymReferenceBlock())) {
        blockId = chainBaseManager.getSolidBlockId();
  ...
  public TransactionCapsule createTransactionCapsule(com.google.protobuf.Message message,
    ...
    if (contractType != ContractType.CreateSmartContract
      ...
      List<Actuator> actList = ActuatorFactory.createActuator(sym, chainBaseManager);
    ...
    if (contractType == ContractType.CreateSmartContract) {
      ...
      CreateSmartContract contract = ContractCapsule
          .getSmartContractFromTransaction(sym.getInstance());
  ...
  public GrpcAPI.Return broadcastTransaction(Transaction signedTransaction) {
    ...
    TransactionCapsule sym = new TransactionCapsule(signedTransaction);
    sym.setTime(System.currentTimeMillis());
    try {
      Message message = new TransactionMessage(signedTransaction.toByteArray());
      if (minEffectiveConnection != 0) {
        if (kcoinNetDelegate.getActivePeer().isEmpty()) {
          logger
              .warn("Broadcast transaction {} has failed, no connection.", sym.getTransactionId());
          return builder.setResult(false).setCode(response_code.NO_CONNECTION)
              .setMessage(ByteString.copyFromUtf8("no connection"))
              .build();
        }

        int count = (int) kcoinNetDelegate.getActivePeer().stream()
        ...
        if (count < minEffectiveConnection) {
          ...
          logger.warn("Broadcast transaction {} has failed, {}.", sym.getTransactionId(), info);
      ...
      if (dbManager.isTooManyPending()) {
        logger
            .warn("Broadcast transaction {} has failed, too many pending.", sym.getTransactionId());
        return builder.setResult(false).setCode(response_code.SERVER_BUSY).build();
      }

      if (dbManager.getTransactionIdCache().getIfPresent(sym.getTransactionId()) != null) {
        logger.warn("Broadcast transaction {} has failed, it already exists.",
            sym.getTransactionId());
        return builder.setResult(false).setCode(response_code.DUP_TRANSACTION_ERROR).build();
      } else {
        dbManager.getTransactionIdCache().put(sym.getTransactionId(), true);
      }
      if (chainBaseManager.getDynamicPropertiesStore().supportVM()) {
        sym.resetResult();
      }
      dbManager.pushTransaction(sym);
      kcoinNetService.broadcast(message);
      logger.info("Broadcast transaction {} successfully.", sym.getTransactionId());
      return builder.setResult(true).setCode(response_code.SUCCESS).build();
    } catch (ValidateSignatureException e) {
      logger.error(BROADCAST_TRANS_FAILED, sym.getTransactionId(), e.getMessage());
  ...
  public TransactionApprovedList getTransactionApprovedList(Transaction sym) {
    TransactionApprovedList.Builder tswBuilder = TransactionApprovedList.newBuilder();
    TransactionExtention.Builder symExBuilder = TransactionExtention.newBuilder();
    symExBuilder.setTransaction(sym);
    symExBuilder.setTxid(ByteString.copyFrom(Sha256Hash.hash(CommonParameter
        .getInstance().isECKeyCryptoEngine(), sym.getRawData().toByteArray())));
    Return.Builder retBuilder = Return.newBuilder();
    retBuilder.setResult(true).setCode(response_code.SUCCESS);
    symExBuilder.setResult(retBuilder);
    tswBuilder.setTransaction(symExBuilder);
    TransactionApprovedList.Result.Builder resultBuilder = TransactionApprovedList.Result
        .newBuilder();
    try {
      Contract contract = sym.getRawData().getContract(0);
      ...
      if (sym.getSignatureCount() > 0) {
        List<ByteString> approveList = new ArrayList<ByteString>();
        byte[] hash = Sha256Hash.hash(CommonParameter
            .getInstance().isECKeyCryptoEngine(), sym.getRawData().toByteArray());
        for (ByteString sig : sym.getSignatureList()) {
          if (sig.size() < 65) {
  ...
  public AccountResourceMessage getAccountResource(ByteString accountAddress) {
    ...
    long totalNetLimit = chainBaseManager.getDynamicPropertiesStore().getTotalNetLimit();
    long totalNetWeight = chainBaseManager.getDynamicPropertiesStore().getTotalNetWeight();
    long totalKcoinPowerWeight = chainBaseManager.getDynamicPropertiesStore()
        .getTotalKcoinPowerWeight();
    ...
    long allKcoinPowerUsage = accountCapsule.getKcoinPowerUsage();
    long allKcoinPower = accountCapsule.getAllKcoinPower() / SYM_PRECISION;
    ...
    builder.setFreeNetUsed(accountCapsule.getFreeNetUsage())
        ...
        .setTotalNetLimit(totalNetLimit)
        .setTotalNetWeight(totalNetWeight)
        .setTotalKcoinPowerWeight(totalKcoinPowerWeight)
        .setEnergyLimit(energyLimit)
        .setEnergyUsed(accountCapsule.getAccountResource().getEnergyUsage())
        .setKcoinPowerUsed(allKcoinPowerUsage)
        .setKcoinPowerLimit(allKcoinPower)
  ...
  public DiversifierMessage getDiversifier() throws ZksnarkException {
    ...
    byte[] d;
    while (true) {
      d = org.kcoin.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public NodeList listNodes() {
    ...
    nodeHandlerMap.entrySet().stream()
        .forEach(v -> {
          org.kcoin.common.overlay.discover.node.Node node = v.getValue()
              .getNode();
  ...
  public Transaction deployContract(TransactionCapsule symCap) {

    // do nothing, so can add some useful function later
    // symCap contract para cacheUnpackValue has value

    return symCap.getInstance();
  }

  public Transaction triggerContract(TriggerSmartContract
      triggerSmartContract,
      TransactionCapsule symCap, Builder builder,
    ...
    if (isConstant(abi, selector)) {
      return callConstantContract(symCap, builder, retBuilder);
    } else {
      return symCap.getInstance();
    }
  }
  ...
  public Transaction callConstantContract(TransactionCapsule symCap, Builder
      builder,
      Return.Builder retBuilder)
      throws ContractValidateException, ContractExeException, HeaderNotFound, VMIllegalException {
    ...
    TransactionContext context = new TransactionContext(new BlockCapsule(headBlock), symCap,
  ...
  private boolean isShieldedTRC20NoteSpent(GrpcAPI.Note note, long pos, byte[] ak,
    ...
    TransactionExtention.Builder symExtBuilder = TransactionExtention.newBuilder();
    Return.Builder retBuilder = Return.newBuilder();
    TransactionExtention symExt;

    try {
      TransactionCapsule symCap = createTransactionCapsule(trigger,
          ContractType.TriggerSmartContract);
      Transaction sym = triggerConstantContract(trigger, symCap, symExtBuilder, retBuilder);

      retBuilder.setResult(true).setCode(response_code.SUCCESS);
      symExtBuilder.setTransaction(sym);
      symExtBuilder.setTxid(symCap.getTransactionId().getByteString());
      symExtBuilder.setResult(retBuilder);
      ...
      symExt = symExtBuilder.build();
    }

    String code = symExt.getResult().getCode().toString();
    if ("SUCCESS".equals(code)) {
      List<ByteString> list = symExt.getConstantResultList();
