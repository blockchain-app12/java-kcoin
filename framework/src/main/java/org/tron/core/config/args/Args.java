package org.kcoin.core.config.args;

import static java.lang.Math.max;
import static java.lang.System.exit;
import static org.kcoin.core.Constant.ADD_PRE_FIX_BYTE_MAINNET;
import static org.kcoin.core.config.Parameter.ChainConstant.BLOCK_PRODUCE_TIMEOUT_PERCENT;
import static org.kcoin.core.config.Parameter.ChainConstant.MAX_ACTIVE_WITNESS_NUM;
...
import org.kcoin.common.args.Account;
import org.kcoin.common.args.GenesisBlock;
import org.kcoin.common.args.Witness;
import org.kcoin.common.config.DbBackupConfig;
import org.kcoin.common.crypto.SignInterface;
import org.kcoin.common.logsfilter.EventPluginConfig;
import org.kcoin.common.logsfilter.FilterQuery;
import org.kcoin.common.logsfilter.TriggerConfig;
...
import org.kcoin.common.parameter.RateLimiterInitialization;
import org.kcoin.common.setting.RocksDbSettings;
import org.kcoin.common.utils.ByteArray;
import org.kcoin.common.utils.Commons;
import org.kcoin.common.utils.FileUtil;
import org.kcoin.common.utils.LocalWitnesses;
import org.kcoin.common.utils.PropUtil;
import org.kcoin.core.Constant;
import org.kcoin.core.Wallet;
import org.kcoin.core.config.Configuration;
import org.kcoin.core.config.Parameter.NetConstants;
import org.kcoin.core.config.Parameter.NodeConstant;
import org.kcoin.core.exception.CipherException;
import org.kcoin.core.store.AccountStore;
import org.kcoin.keystore.Credentials;
import org.kcoin.keystore.WalletUtils;
...
public class Args extends CommonParameter {
  ...
  public static void clearParam() {
    ...
    PARAMETER.symExpirationTimeInMilliseconds = 0;
  ...
  public static void setParam(final String[] args, final String confFileName) {
    ...
    PARAMETER.netMaxSymPerSecond = config.hasPath(Constant.NODE_NET_MAX_SYM_PER_SECOND)
        ? config.getInt(Constant.NODE_NET_MAX_SYM_PER_SECOND)
        : NetConstants.NET_MAX_SYM_PER_SECOND;
    ...
    PARAMETER.needToUpdateAsset =
        config.hasPath(Constant.STORAGE_NEEDTO_UPDATE_ASSET) ? config
            ...
            : true;
    PARAMETER.symReferenceBlock = config.hasPath(Constant.SYM_REFERENCE_BLOCK)
        ? config.getString(Constant.SYM_REFERENCE_BLOCK) : "head";

    PARAMETER.symExpirationTimeInMilliseconds =
        config.hasPath(Constant.SYM_EXPIRATION_TIME_IN_MILLIS_SECONDS)
            && config.getLong(Constant.SYM_EXPIRATION_TIME_IN_MILLIS_SECONDS) > 0
            ? config.getLong(Constant.SYM_EXPIRATION_TIME_IN_MILLIS_SECONDS)
