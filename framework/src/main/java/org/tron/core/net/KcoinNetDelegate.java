...
import org.kcoin.common.backup.BackupServer;
...
import org.kcoin.core.metrics.MetricsService;
...
public class KcoinNetDelegate {
  ...
  public boolean contain(Sha256Hash hash, MessageTypes type) {
    ...
    } else if (type.equals(MessageTypes.SYM)) {
  ...
  public void pushTransaction(TransactionCapsule sym) throws P2pException {
    try {
      ...
      throw new P2pException(TypeEnum.BAD_SYM, e);
      ...
      throw new P2pException(TypeEnum.SYM_EXE_FAILED, e);
    }
  }
