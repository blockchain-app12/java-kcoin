...
import org.kcoin.core.net.messagehandler.BlockMsgHandler;
import org.kcoin.core.net.messagehandler.ChainInventoryMsgHandler;
import org.kcoin.core.net.messagehandler.FetchInvDataMsgHandler;
import org.kcoin.core.net.messagehandler.InventoryMsgHandler;
import org.kcoin.core.net.messagehandler.PbftDataSyncHandler;
import org.kcoin.core.net.messagehandler.SyncBlockChainMsgHandler;
import org.kcoin.core.net.messagehandler.TransactionsMsgHandler;
import org.kcoin.core.net.peer.PeerConnection;
import org.kcoin.core.net.peer.PeerStatusCheck;
...
public class KcoinNetService {
  ...
  public void start() {
    ...
    logger.info("KcoinNetService start successfully.");
  }
  ...
  public void stop() {
    ...
    logger.info("KcoinNetService closed successfully.");
  }
  ...
  protected void onMessage(PeerConnection peer, KcoinMessage msg) {
    try {
      switch (msg.getType()) {
  ...
  private void processException(PeerConnection peer, KcoinMessage msg, Exception ex) {
    ReasonCode code;
