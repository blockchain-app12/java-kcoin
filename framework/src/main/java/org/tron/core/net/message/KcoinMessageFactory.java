...
import org.kcoin.common.overlay.message.MessageFactory;
 ...
 * msg factory.
 */
public class KcoinMessageFactory extends MessageFactory {

  private static final String DATA_LEN = ", len=";

  @Override
  public KcoinMessage create(byte[] data) throws Exception {
  ...
  private KcoinMessage create(byte type, byte[] packed) throws Exception {
