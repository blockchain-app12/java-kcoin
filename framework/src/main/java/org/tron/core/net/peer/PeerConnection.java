package org.kcoin.core.net.peer;
...
public class PeerConnection extends Channel {
  ...
  public void onConnect() {
    ...
    if (peerHeadBlockNum > headBlockNum) {
      ...
      setKcoinState(KcoinState.SYNC_COMPLETED);
    }
  }
