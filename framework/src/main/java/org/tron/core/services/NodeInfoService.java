...
import org.kcoin.common.entity.NodeInfo.ConfigNodeInfo;
import org.kcoin.common.entity.NodeInfo.MachineInfo;
import org.kcoin.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.kcoin.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.kcoin.common.entity.PeerInfo;
...
import org.kcoin.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getKcoinLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getKcoinLastRemoteDisconnectReason();
