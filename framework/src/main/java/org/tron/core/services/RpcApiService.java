...
import org.kcoin.api.GrpcAPI.BlockLimit;
import org.kcoin.api.GrpcAPI.BlockList;
import org.kcoin.api.GrpcAPI.BlockListExtention;
...
import org.kcoin.api.GrpcAPI.DecryptNotesMarked;
...
import org.kcoin.api.GrpcAPI.EasyTransferAssetByPrivateMessage;
import org.kcoin.api.GrpcAPI.EasyTransferAssetMessage;
import org.kcoin.api.GrpcAPI.EasyTransferByPrivateMessage;
import org.kcoin.api.GrpcAPI.EasyTransferMessage;
...
import org.kcoin.api.GrpcAPI.IncomingViewingKeyDiversifierMessage;
...
import org.kcoin.api.GrpcAPI.TransactionIdList;
import org.kcoin.api.GrpcAPI.TransactionInfoList;
import org.kcoin.api.GrpcAPI.TransactionList;
import org.kcoin.api.GrpcAPI.TransactionListExtention;
import org.kcoin.api.GrpcAPI.TransactionSignWeight;
import org.kcoin.api.GrpcAPI.ViewingKeyMessage;
import org.kcoin.api.GrpcAPI.WitnessList;
import org.kcoin.api.MonitorGrpc;
import org.kcoin.api.WalletExtensionGrpc;
import org.kcoin.api.WalletGrpc.WalletImplBase;
...
import org.kcoin.core.metrics.MetricsApiService;
...
import org.kcoin.protos.Protocol.NodeInfo;
...
import org.kcoin.protos.contract.AccountContract.AccountPermissionUpdateContract;
import org.kcoin.protos.contract.AccountContract.AccountUpdateContract;
import org.kcoin.protos.contract.AccountContract.SetAccountIdContract;
import org.kcoin.protos.contract.AssetIssueContractOuterClass.AssetIssueContract;
import org.kcoin.protos.contract.AssetIssueContractOuterClass.ParticipateAssetIssueContract;
import org.kcoin.protos.contract.AssetIssueContractOuterClass.TransferAssetContract;
import org.kcoin.protos.contract.AssetIssueContractOuterClass.UnfreezeAssetContract;
import org.kcoin.protos.contract.AssetIssueContractOuterClass.UpdateAssetContract;
import org.kcoin.protos.contract.BalanceContract.AccountBalanceRequest;
import org.kcoin.protos.contract.BalanceContract.AccountBalanceResponse;
import org.kcoin.protos.contract.BalanceContract.BlockBalanceTrace;
import org.kcoin.protos.contract.BalanceContract.FreezeBalanceContract;
import org.kcoin.protos.contract.BalanceContract.TransferContract;
import org.kcoin.protos.contract.BalanceContract.UnfreezeBalanceContract;
import org.kcoin.protos.contract.BalanceContract.WithdrawBalanceContract;
import org.kcoin.protos.contract.ExchangeContract.ExchangeCreateContract;
import org.kcoin.protos.contract.ExchangeContract.ExchangeInjectContract;
import org.kcoin.protos.contract.ExchangeContract.ExchangeTransactionContract;
import org.kcoin.protos.contract.ExchangeContract.ExchangeWithdrawContract;
import org.kcoin.protos.contract.MarketContract.MarketCancelOrderContract;
import org.kcoin.protos.contract.MarketContract.MarketSellAssetContract;
import org.kcoin.protos.contract.ProposalContract.ProposalApproveContract;
import org.kcoin.protos.contract.ProposalContract.ProposalCreateContract;
import org.kcoin.protos.contract.ProposalContract.ProposalDeleteContract;
...
import org.kcoin.protos.contract.SmartContractOuterClass.ClearABIContract;
...
import org.kcoin.protos.contract.SmartContractOuterClass.UpdateEnergyLimitContract;
import org.kcoin.protos.contract.SmartContractOuterClass.UpdateSettingContract;
import org.kcoin.protos.contract.StorageContract.UpdateBrokerageContract;
...
import org.kcoin.protos.contract.WitnessContract.WitnessUpdateContract;
...
public class RpcApiService implements Service {
  ...
  private void callContract(TriggerSmartContract request,
    ...
    try {
      TransactionCapsule symCap = createTransactionCapsule(request,
          ContractType.TriggerSmartContract);
      Transaction sym;
      if (isConstant) {
        sym = wallet.triggerConstantContract(request, symCap, symExtBuilder, retBuilder);
      } else {
        sym = wallet.triggerContract(request, symCap, symExtBuilder, retBuilder);
      }
      ...
      responseObserver.onNext(symExtBuilder.build());
  ...
  private TransactionExtention transaction2Extention(Transaction transaction) {
    ...
    TransactionExtention.Builder symExtBuilder = TransactionExtention.newBuilder();
    Return.Builder retBuilder = Return.newBuilder();
    symExtBuilder.setTransaction(transaction);
    symExtBuilder.setTxid(Sha256Hash.of(CommonParameter.getInstance()
        .isECKeyCryptoEngine(), transaction.getRawData().toByteArray()).getByteString());
    retBuilder.setResult(true).setCode(response_code.SUCCESS);
    symExtBuilder.setResult(retBuilder);
    return symExtBuilder.build();
  }
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.kcoin.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.kcoin.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletSolidityApi extends WalletSolidityImplBase {
    ...
    public void getBurnSym(EmptyMessage request, StreamObserver<NumberMessage> responseObserver) {
      getBurnSymCommon(request, responseObserver);
    }
    ...
    @Override
    public void getMarketOrderListByPair(org.kcoin.protos.Protocol.MarketOrderPair request,
        StreamObserver<MarketOrderList> responseObserver) {
      try {
  ...
  public class WalletApi extends WalletImplBase {
    ...
    private void createTransactionExtention(Message request, ContractType contractType,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule sym = createTransactionCapsule(request, contractType);
        symExtBuilder.setTransaction(sym.getInstance());
        symExtBuilder.setTxid(sym.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (ContractValidateException e) {
        retBuilder.setResult(false).setCode(response_code.CONTRACT_VALIDATE_ERROR)
    ...
    public void getTransactionSign2(TransactionSign req,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule sym = TransactionUtil.getTransactionSign(req);
        symExtBuilder.setTransaction(sym.getInstance());
        symExtBuilder.setTxid(sym.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (Exception e) {
    ...
    public void addSign(TransactionSign req,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule sym = transactionUtil.addSign(req);
        symExtBuilder.setTransaction(sym.getInstance());
        symExtBuilder.setTxid(sym.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (Exception e) {
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      if (dbManager.getDynamicPropertiesStore().supportAllowNewResourceModel()) {
        Preconditions.checkArgument(account.getAllKcoinPower() < votesCount,
            "kcoin power[" + account.getAllKcoinPower() + "] <  VotesCount[" + votesCount + "]");
      } else {
        Preconditions.checkArgument(account.getKcoinPower() < votesCount,
            "kcoin power[" + account.getKcoinPower() + "] <  VotesCount[" + votesCount + "]");
      }
    ...
    public void listNodes(EmptyMessage request, StreamObserver<NodeList> responseObserver) {
      ...
      nodeHandlerMap.entrySet().stream()
          .forEach(v -> {
            org.kcoin.common.overlay.discover.node.Node node = v.getValue().getNode();
    ...
    public void createShieldedTransaction(PrivateParameters request,
      ...
      try {
        ...
        TransactionCapsule sym = wallet.createShieldedTransaction(request);
        symExtBuilder.setTransaction(sym.getInstance());
        symExtBuilder.setTxid(sym.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
    ...
    public void createShieldedTransactionWithoutSpendAuthSig(PrivateParametersWithoutAsk request,
      ...
      try {
        ...
        TransactionCapsule sym = wallet.createShieldedTransactionWithoutSpendAuthSig(request);
        symExtBuilder.setTransaction(sym.getInstance());
        symExtBuilder.setTxid(sym.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (ContractValidateException | ZksnarkException e) {
    ...
    public void createShieldedContractParameters(
        ...
        StreamObserver<org.kcoin.api.GrpcAPI.ShieldedTRC20Parameters> responseObserver) {
      try {
        checkSupportShieldedTRC20Transaction();
    ...
    public void scanShieldedTRC20NotesByIvk(
        ...
        StreamObserver<org.kcoin.api.GrpcAPI.DecryptNotesTRC20> responseObserver) {
      long startNum = request.getStartBlockIndex();
      long endNum = request.getEndBlockIndex();
      try {
        checkSupportShieldedTRC20Transaction();
    ...
    public void getTriggerInputForShieldedTRC20Contract(
        ...
        io.grpc.stub.StreamObserver<org.kcoin.api.GrpcAPI.BytesMessage> responseObserver) {
      try {
        checkSupportShieldedTRC20Transaction();
  ...
  public void getBurnSymCommon(EmptyMessage request,
      StreamObserver<NumberMessage> responseObserver) {
    try {
      long value = dbManager.getDynamicPropertiesStore().getBurnSymAmount();
      NumberMessage.Builder builder = NumberMessage.newBuilder();
      builder.setNum(value);
      responseObserver.onNext(builder.build());
    } catch (Exception e) {
