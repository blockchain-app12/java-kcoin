...
import static org.kcoin.common.utils.Commons.decodeFromBase58Check;
...
import org.kcoin.core.services.http.JsonFormat.ParseException;
...
public class Util {
  ...
  public static List<Log> convertLogAddressToKcoinAddress(TransactionInfo transactionInfo) {
    ...
    for (Log log : transactionInfo.getLogList()) {
      ...
      if (oldAddress.length == 0 || oldAddress.length > 20) {
        ...
        logBuilder
            .setAddress(ByteString.copyFrom(TransactionTrace.convertToKcoinAddress(newAddress)));
      }
