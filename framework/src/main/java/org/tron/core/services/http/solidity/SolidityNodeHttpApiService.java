package org.kcoin.core.services.http.solidity;
...
import org.kcoin.core.services.http.GetAccountByIdServlet;
import org.kcoin.core.services.http.GetAccountServlet;
import org.kcoin.core.services.http.GetAssetIssueByIdServlet;
import org.kcoin.core.services.http.GetAssetIssueByNameServlet;
import org.kcoin.core.services.http.GetAssetIssueListByNameServlet;
import org.kcoin.core.services.http.GetAssetIssueListServlet;
import org.kcoin.core.services.http.GetBlockByIdServlet;
import org.kcoin.core.services.http.GetBlockByLatestNumServlet;
import org.kcoin.core.services.http.GetBlockByLimitNextServlet;
import org.kcoin.core.services.http.GetBlockByNumServlet;
import org.kcoin.core.services.http.GetBrokerageServlet;
import org.kcoin.core.services.http.GetBurnSymServlet;
import org.kcoin.core.services.http.GetDelegatedResourceAccountIndexServlet;
import org.kcoin.core.services.http.GetDelegatedResourceServlet;
import org.kcoin.core.services.http.GetExchangeByIdServlet;
import org.kcoin.core.services.http.GetMarketOrderByAccountServlet;
import org.kcoin.core.services.http.GetMarketOrderByIdServlet;
import org.kcoin.core.services.http.GetMarketOrderListByPairServlet;
import org.kcoin.core.services.http.GetMarketPairListServlet;
import org.kcoin.core.services.http.GetMarketPriceByPairServlet;
import org.kcoin.core.services.http.GetMerkleTreeVoucherInfoServlet;
import org.kcoin.core.services.http.GetNodeInfoServlet;
import org.kcoin.core.services.http.GetNowBlockServlet;
import org.kcoin.core.services.http.GetPaginatedAssetIssueListServlet;
import org.kcoin.core.services.http.GetRewardServlet;
import org.kcoin.core.services.http.GetTransactionCountByBlockNumServlet;
import org.kcoin.core.services.http.GetTransactionInfoByBlockNumServlet;
import org.kcoin.core.services.http.IsShieldedTRC20ContractNoteSpentServlet;
import org.kcoin.core.services.http.IsSpendServlet;
import org.kcoin.core.services.http.ListExchangesServlet;
import org.kcoin.core.services.http.ListWitnessesServlet;
import org.kcoin.core.services.http.ScanAndMarkNoteByIvkServlet;
import org.kcoin.core.services.http.ScanNoteByIvkServlet;
import org.kcoin.core.services.http.ScanNoteByOvkServlet;
import org.kcoin.core.services.http.ScanShieldedTRC20NotesByIvkServlet;
import org.kcoin.core.services.http.ScanShieldedTRC20NotesByOvkServlet;
import org.kcoin.core.services.http.TriggerConstantContractServlet;
...
public class SolidityNodeHttpApiService implements Service {
  ...
  @Autowired
  private GetBurnSymServlet getBurnSymServlet;
  @Autowired
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(getBurnSymServlet), "/walletsolidity/getburnsym");
