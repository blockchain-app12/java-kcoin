package org.kcoin.core.services.interfaceOnPBFT.http.PBFT;
...
import org.kcoin.core.services.interfaceOnPBFT.http.GetAccountByIdOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetAccountOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetAssetIssueByIdOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetAssetIssueByNameOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetAssetIssueListByNameOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetAssetIssueListOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetBlockByIdOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetBlockByLatestNumOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetBlockByLimitNextOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetBlockByNumOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetBrokerageOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetBurnSymOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetDelegatedResourceAccountIndexOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetDelegatedResourceOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetExchangeByIdOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetMarketOrderByAccountOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetMarketOrderByIdOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetMarketOrderListByPairOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetMarketPairListOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetMarketPriceByPairOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetMerkleTreeVoucherInfoOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetNodeInfoOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetNowBlockOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetPaginatedAssetIssueListOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetRewardOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.GetTransactionCountByBlockNumOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.IsShieldedTRC20ContractNoteSpentOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.IsSpendOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.ListExchangesOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.ListWitnessesOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.ScanAndMarkNoteByIvkOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.ScanNoteByIvkOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.ScanNoteByOvkOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.ScanShieldedTRC20NotesByIvkOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.ScanShieldedTRC20NotesByOvkOnPBFTServlet;
import org.kcoin.core.services.interfaceOnPBFT.http.TriggerConstantContractOnPBFTServlet;
...
public class HttpApiOnPBFTService implements Service {
  ...
  @Autowired
  private GetBurnSymOnPBFTServlet getBurnSymOnPBFTServlet;
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(getBurnSymOnPBFTServlet),
          "/getburnsym");
