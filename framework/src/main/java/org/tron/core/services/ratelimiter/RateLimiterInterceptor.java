package org.kcoin.core.services.ratelimiter;
...
import org.kcoin.common.parameter.RateLimiterInitialization.RpcRateLimiterItem;
import org.kcoin.core.config.args.Args;
import org.kcoin.core.metrics.MetricsKey;
import org.kcoin.core.metrics.MetricsUtil;
import org.kcoin.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import org.kcoin.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import org.kcoin.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import org.kcoin.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import org.kcoin.core.services.ratelimiter.adapter.IRateLimiter;
import org.kcoin.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;
      ...
      try {
        ...
        switch (cName) {
          case "GlobalPreemptibleAdapter":
            cls = org.kcoin.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
          case "QpsRateLimiterAdapter":
            cls = org.kcoin.core.services.ratelimiter.adapter.QpsRateLimiterAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
          case "IPQPSRateLimiterAdapter":
            cls = org.kcoin.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
