package org.kcoin.core.zen.note;

import static org.kcoin.common.zksnark.JLibsodium.CRYPTO_AEAD_CHACHA20POLY1305_IETF_NPUBBYTES;
import static org.kcoin.core.utils.ZenChainParams.ZC_ENCCIPHERTEXT_SIZE;
import static org.kcoin.core.utils.ZenChainParams.ZC_ENCPLAINTEXT_SIZE;
import static org.kcoin.core.utils.ZenChainParams.ZC_OUTCIPHERTEXT_SIZE;
import static org.kcoin.core.utils.ZenChainParams.ZC_OUTPLAINTEXT_SIZE;
import static org.kcoin.core.zen.note.NoteEncryption.Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE;
...
import org.kcoin.common.zksnark.JLibsodiumParam.Chacha20Poly1305IetfEncryptParams;
...
import org.kcoin.core.utils.ZenChainParams;
import org.kcoin.core.zen.address.DiversifierT;
import org.kcoin.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
import org.kcoin.core.zen.note.NoteEncryption.Encryption.EncPlaintext;
import org.kcoin.core.zen.note.NoteEncryption.Encryption.OutCiphertext;
import org.kcoin.core.zen.note.NoteEncryption.Encryption.OutPlaintext;
...
public class NoteEncryption {
  ...
  public static class Encryption {
    ...
    public static void prfOck(byte[] ock, byte[] ovk, byte[] cv, byte[] cm, byte[] epk)
      ...
      byte[] temp = "Zkcoin_Derive_ock".getBytes();
    ...
    public static void kdfSapling(byte[] kEnc, byte[] sharedsecret, byte[] epk)
      ...
      byte[] personalization = new byte[JLibsodium.CRYPTO_GENERICHASH_BLAKE2B_PERSONALBYTES];
      byte[] temp = "Zkcoin_SaplingKDF".getBytes();
      System.arraycopy(temp, 0, personalization, 0, temp.length);
      if (JLibsodium.cryptoGenerichashBlack2bSaltPersonal(new Black2bSaltPersonalParams(
