...
import org.kcoin.common.overlay.client.DatabaseGrpcClient;
...
import org.kcoin.core.services.http.solidity.SolidityNodeHttpApiService;
...
public class SolidityNode {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new KcoinApplicationContext(DefaultConfig.class);
    ...
    nodeManager.close();
    KcoinNetService kcoinNetService = context.getBean(KcoinNetService.class);
