...
public class TvmTestUtils {
  ...
  public static byte[] deployContractWholeProcessReturnContractAddress(String contractName,
    ...
    Transaction sym = generateDeploySmartContractAndGetTransaction(contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);
    processTransactionAndReturnRuntime(sym, deposit, block);
    return WalletUtil.generateContractAddress(sym);
  }
  ...
  public static Runtime triggerContractWholeProcessReturnContractAddress(byte[] callerAddress,
    ...
    return processTransactionAndReturnRuntime(sym, deposit, block);
  }
  ...
  public static Transaction generateDeploySmartContractAndGetTransaction(String contractName,
    ...
    TransactionCapsule symCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = symCapWithoutFeeLimit.getInstance().toBuilder();

    Transaction.raw.Builder rawBuilder = symCapWithoutFeeLimit.getInstance().getRawData()
        .toBuilder();
    rawBuilder.setFeeLimit(feeLimit);
    transactionBuilder.setRawData(rawBuilder);
    Transaction sym = transactionBuilder.build();
    return sym;
  }
  ...
  public static Runtime processTransactionAndReturnRuntime(Transaction sym,
  ...
  public static TransactionTrace processTransactionAndReturnTrace(Transaction sym,
  ...
  public static TVMTestResult deployContractAndReturnTvmTestResult(String contractName,
    ...
    return processTransactionAndReturnTvmTestResult(sym, dbManager, blockCap)
        .setContractAddress(WalletUtil.generateContractAddress(sym));
  }
  ...
  public static TVMTestResult deployContractWithCreatorEnergyLimitAndReturnTvmTestResult(
      ...
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction sym = generateDeploySmartContractWithCreatorEnergyLimitAndGetTransaction(
  ...
  public static TVMTestResult processTransactionAndReturnTvmTestResult(Transaction sym,
