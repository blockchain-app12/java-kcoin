...
public class BandWidthRuntimeOutOfTimeWithCheckTest {
  ...
  private String sym2ContractAddress = "TPMBUANrTwwQAPwShn7ZZjTJz1f3F8jknj";
  ...
  public void testSuccess() {
    try {
      ...
      TransactionCapsule symCap = new TransactionCapsule(transaction);
      symCap.setResultCode(contractResult.OUT_OF_ENERGY);
      TransactionTrace trace = new TransactionTrace(symCap, StoreFactory.getInstance(),
          new RuntimeImpl());
      dbManager.consumeBandwidth(symCap, trace);
