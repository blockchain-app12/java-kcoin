...
public class DepositTest {
  ...
  public void loopCallTest()
    ...
    Runtime runtime = TvmTestUtils
        .processTransactionAndReturnRuntime(aSym, DepositImpl.createRoot(manager),
            null);
    ...
    byte[] aAddress = WalletUtil.generateContractAddress(aSym);
    byte[] bAddress = WalletUtil.generateContractAddress(bSym);
  ...
  public void loopCallTestOldVersion()
    ...
    Runtime runtime = TvmTestUtils.processTransactionAndReturnRuntime(aSym, rootDeposit,
        null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    Transaction bSym = TvmTestUtils.generateDeploySmartContractAndGetTransaction(
        ...
        null);
    rootDeposit = DepositImpl.createRoot(manager);
    runtime = TvmTestUtils.processTransactionAndReturnRuntime(bSym, rootDeposit, null);
    Assert.assertNull(runtime.getRuntimeError());
