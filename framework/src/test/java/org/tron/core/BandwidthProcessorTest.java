...
public class BandwidthProcessorTest {
  ...
  private static final int SYM_NUM = 2;
  ...
  public void testCreateNewAccount() throws Exception {
    ...
    TransactionCapsule sym = new TransactionCapsule(transferAssetContract);
    ...
    org.kcoin.protos.Protocol.Transaction.Contract contract =
        org.kcoin.protos.Protocol.Transaction.Contract
            .newBuilder()
    ...
    long bytes = sym.getSerializedSize();
    TransactionTrace trace = new TransactionTrace(sym, StoreFactory
  ...
  public void testFree() throws Exception {
    ...
    TransactionCapsule sym = new TransactionCapsule(contract);
    ...
    TransactionTrace trace = new TransactionTrace(sym, StoreFactory
        .getInstance(), new RuntimeImpl());
    dbManager.consumeBandwidth(sym, trace);
  ...
  public void sameTokenNameCloseConsumeSuccess() {
    ...
    long byteSize = sym.getInstance().toBuilder().clearRet().build().getSerializedSize()
        + Constant.MAX_RESULT_SIZE_IN_TX;
  ...
  public void sameTokenNameCloseTransferToAccountNotExist() {
    ...
    TransactionCapsule sym = new TransactionCapsule(contract, chainBaseManager.getAccountStore());
    TransactionTrace trace = new TransactionTrace(sym, StoreFactory
        .getInstance(), new RuntimeImpl());
