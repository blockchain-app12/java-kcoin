...
import static stest.kcoin.wallet.common.client.utils.PublicMethed.decode58Check;
...
import org.kcoin.core.utils.ProposalUtil.ProposalType;
...
import org.kcoin.protos.Protocol.BlockHeader.raw;
...
public class WalletTest {
  ...
  private static void addTransactionInfoToStore(Transaction transaction) {
    ...
    byte[] symId = transaction.getRawData().toByteArray();
    transactionInfo.setId(symId);
    chainBaseManager.getTransactionHistoryStore().put(symId, transactionInfo);
  }
