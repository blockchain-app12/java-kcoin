...
public class MarketSellAssetActuatorTest {
  ...
  /**
   * no Enough Balance For Selling SYM, result is failed, exception is "No enough balance !".
   */
  @Test
  public void noEnoughBalanceForSellingSYM() {
  ...
  /**
   * no buy orders before,add first sell order,selling SYM and buying token
   */
  @Test
  ...
  /**
   * no buy orders before,add first sell order,selling Token and buying SYM
   */
  @Test
