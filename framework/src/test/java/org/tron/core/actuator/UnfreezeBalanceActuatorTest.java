...
import org.kcoin.protos.contract.Common.ResourceCode;
...
public class UnfreezeBalanceActuatorTest {
  ...
  private Any getContractForKcoinPower(String ownerAddress) {
    return Any.pack(UnfreezeBalanceContract.newBuilder()
        .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(ownerAddress)))
        .setResource(ResourceCode.KCOIN_POWER).build());
  }
  ...
  public void testUnfreezeBalanceForBandwidth() {
    ...
    Assert.assertEquals(accountCapsule.getKcoinPower(), frozenBalance);
    ...
    try {
      ...
      Assert.assertEquals(owner.getKcoinPower(), 0L);
  ...
  public void testUnfreezeDelegatedBalanceForBandwidth() {
    ...
    Assert.assertEquals(frozenBalance, owner.getKcoinPower());
    ...
    Assert.assertEquals(0L, receiver.getKcoinPower());
    ...
    try {
      ...
      Assert.assertEquals(0L, ownerResult.getKcoinPower());
  ...
  @Test
  public void testUnfreezeBalanceForEnergyWithOldKcoinPowerAfterNewResourceModel() {
    long now = System.currentTimeMillis();
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(now);
    ...
    AccountCapsule accountCapsule = dbManager.getAccountStore()
        .get(ByteArray.fromHexString(OWNER_ADDRESS));
    accountCapsule.setFrozenForEnergy(frozenBalance, now);
    accountCapsule.setOldKcoinPower(frozenBalance);
    ...
    try {
      ...
      Assert.assertEquals(owner.getInstance().getOldKcoinPower(), -1L);
    } catch (ContractValidateException e) {
      Assert.assertFalse(e instanceof ContractValidateException);
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
  ...
  @Test
  public void testUnfreezeBalanceForEnergyWithoutOldKcoinPowerAfterNewResourceModel() {
    long now = System.currentTimeMillis();
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(now);
    dbManager.getDynamicPropertiesStore().saveAllowNewResourceModel(1L);
    ...
    AccountCapsule accountCapsule = dbManager.getAccountStore()
        .get(ByteArray.fromHexString(OWNER_ADDRESS));
    accountCapsule.setFrozenForEnergy(frozenBalance, now);
    accountCapsule.setOldKcoinPower(-1L);
    accountCapsule.addVotes(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)), 100L);
  ...
  @Test
  public void testUnfreezeBalanceForKcoinPowerWithOldKcoinPowerAfterNewResourceModel() {
    long now = System.currentTimeMillis();
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(now);
    dbManager.getDynamicPropertiesStore().saveAllowNewResourceModel(1L);
    ...
    AccountCapsule accountCapsule = dbManager.getAccountStore()
        .get(ByteArray.fromHexString(OWNER_ADDRESS));
    accountCapsule.setFrozenForEnergy(frozenBalance, now);
    accountCapsule.setFrozenForKcoinPower(frozenBalance, now);
    accountCapsule.addVotes(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)), 100L);

    dbManager.getAccountStore().put(accountCapsule.createDbKey(), accountCapsule);
    UnfreezeBalanceActuator actuator = new UnfreezeBalanceActuator();
    actuator.setChainBaseManager(dbManager.getChainBaseManager())
        .setAny(getContractForKcoinPower(OWNER_ADDRESS));
    TransactionResultCapsule ret = new TransactionResultCapsule();
  ...
  @Test
  public void testUnfreezeBalanceForKcoinPowerWithOldKcoinPowerAfterNewResourceModelError() {
    long now = System.currentTimeMillis();
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(now);
    dbManager.getDynamicPropertiesStore().saveAllowNewResourceModel(1L);
    ...
    AccountCapsule accountCapsule = dbManager.getAccountStore()
        .get(ByteArray.fromHexString(OWNER_ADDRESS));
    accountCapsule.setFrozenForEnergy(frozenBalance, now);
    accountCapsule.setFrozenForKcoinPower(frozenBalance, now + 100000000L);
    accountCapsule.addVotes(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)), 100L);
