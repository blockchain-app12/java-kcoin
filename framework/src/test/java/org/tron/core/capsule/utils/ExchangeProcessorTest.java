...
import org.kcoin.core.capsule.ExchangeProcessor;
...
public class ExchangeProcessorTest {
  ...
  public void testExchange() {
    ...
    long sellQuant = 2_000_000_000_000L; // 2 million sym
  ...
  public void testExchange2() {
    long sellBalance = 100_000_000_000000L;
    long buyBalance = 128L * 1024 * 1024 * 1024;
    long sellQuant = 1_000_000_000_000L; // 2 million sym
  ...
  public void testInject() {
    ...
    long sellQuant = 10_000_000L; // 10 sym
