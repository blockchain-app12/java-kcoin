...
import static org.kcoin.common.utils.Commons.adjustAssetBalanceV2;
import static org.kcoin.common.utils.Commons.adjustBalance;
import static org.kcoin.common.utils.Commons.adjustTotalShieldedPoolValue;
...
import org.kcoin.protos.contract.AccountContract;
import org.kcoin.protos.contract.AssetIssueContractOuterClass;
import org.kcoin.protos.contract.BalanceContract.TransferContract;
import org.kcoin.protos.contract.ShieldContract;
import stest.kcoin.wallet.dailybuild.operationupdate.MutiSignSmartContractTest;
...
public class ManagerTest extends BlockGenerate {
  ...
  public void setBlockReference()
    ...
    if (chainManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() == 0) {
      ...
      chainManager.setBlockReference(sym);
      Assert.assertEquals(1,
          ByteArray.toInt(sym.getInstance().getRawData().getRefBlockBytes().toByteArray()));
    }
  ...
  public void pushBlockInvalidMerkelRoot() {
    Transaction sym = Transaction.newBuilder().build();
    TransactionCapsule moreTrans = new TransactionCapsule(sym);
  ...
  public void pushBlockTooMuchShieldedTransactions() {
    ShieldContract.ShieldedTransferContract sym1 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(10)
        .setToAmount(10)
        .build();
    ShieldContract.ShieldedTransferContract sym2 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(20)
        .setToAmount(20)
        .build();
    TransactionCapsule trans1 = new TransactionCapsule(sym1, ContractType.ShieldedTransferContract);
    TransactionCapsule trans2 = new TransactionCapsule(sym2, ContractType.ShieldedTransferContract);
