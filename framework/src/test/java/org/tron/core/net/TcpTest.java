...
import static org.kcoin.core.net.message.MessageTypes.P2P_DISCONNECT;
import static org.kcoin.core.net.message.MessageTypes.P2P_HELLO;
import static org.kcoin.protos.Protocol.ReasonCode.DUPLICATE_PEER;
import static org.kcoin.protos.Protocol.ReasonCode.FORKED;
import static org.kcoin.protos.Protocol.ReasonCode.INCOMPATIBLE_CHAIN;
import static org.kcoin.protos.Protocol.ReasonCode.INCOMPATIBLE_VERSION;
...
import org.kcoin.common.overlay.message.P2pMessage;
import org.kcoin.common.overlay.message.P2pMessageFactory;
...
public class TcpTest {
  ...
  public TcpTest(KcoinApplicationContext context) {
    channelManager = context.getBean(ChannelManager.class);
    manager = context.getBean(Manager.class);
    chainBaseManager = context.getBean(ChainBaseManager.class);
    pool = context.getBean(SyncPool.class);
    kcoinNetDelegate = context.getBean(KcoinNetDelegate.class);
  }
  ...
  private void validResultCloseConnect(Channel channel) throws InterruptedException {
    ...
    Collection<PeerConnection> peerConnections = ReflectUtils
        .invokeMethod(kcoinNetDelegate, "getActivePeer");
