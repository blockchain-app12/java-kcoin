...
import static org.kcoin.core.capsule.TransactionCapsule.getShieldTransactionHashIgnoreTypeException;
...
import org.kcoin.common.zksnark.IncrementalMerkleTreeContainer.EmptyMerkleRoots;
...
import org.kcoin.common.zksnark.LibrustzcashParam.ComputeCmParams;
import org.kcoin.common.zksnark.LibrustzcashParam.FinalCheckParams;
...
import org.kcoin.common.zksnark.MerklePath;
import org.kcoin.common.zksnark.ZksnarkClient;
...
public class SendCoinShieldTest {
  ...
  public void createCapsule() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setId(Long.toString(tokenId)).setTotalSupply(OWNER_BALANCE).setSymNum(SYM_NUM).setNum(NUM)
