package org.kcoin.core.zksnark;
...
import org.kcoin.common.zksnark.LibrustzcashParam.BindingSigParams;
import org.kcoin.common.zksnark.LibrustzcashParam.CheckOutputParams;
import org.kcoin.common.zksnark.LibrustzcashParam.CheckSpendParams;
import org.kcoin.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.kcoin.common.zksnark.LibrustzcashParam.OutputProofParams;
...
import org.kcoin.core.capsule.ReceiveDescriptionCapsule;
import org.kcoin.core.capsule.SpendDescriptionCapsule;
...
import org.kcoin.core.db.BlockGenerate;
...
import org.kcoin.core.services.http.FullNodeHttpApiService;
import org.kcoin.core.utils.TransactionUtil;
import org.kcoin.core.zen.ZenTransactionBuilder;
import org.kcoin.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
import org.kcoin.core.zen.ZenTransactionBuilder.SpendDescriptionInfo;
...
import org.kcoin.core.zen.note.Note.NotePlaintextEncryptionResult;
...
public class ShieldedReceiveTest extends BlockGenerate {
  ...
  private static final String ASSET_NAME = "sym";
  private static final int SYM_NUM = 10;
  private static final int NUM = 1;
  private static final long START_TIME = 1;
  private static final long END_TIME = 2;
  private static final int VOTE_SCORE = 2;
  private static final String DESCRIPTION = "SYM";
  ...
  private static byte[] randomUint256() {
    return org.kcoin.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.kcoin.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.kcoin.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.kcoin.keystore.Wallet.generateRandomBytes(580);
  }
 ...
 */
  ...
  public void testDiversifierT() throws ZksnarkException {
    //byte[] data = org.kcoin.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.kcoin.keystore.Wallet.generateRandomBytes(1024);
    ...
    for (org.kcoin.protos.Protocol.Transaction.Contract c : t.getRawData().getContractList()) {
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.kcoin.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
  ...
  public void pushSameSkAndScanAndSpend() throws Exception {
    ...
    byte[] memo = org.kcoin.keystore.Wallet.generateRandomBytes(512);
    ...
    byte[] symId = transactionCap.getTransactionId().getBytes();
    boolean ok = dbManager.pushTransaction(transactionCap);
    Assert.assertTrue(ok);
    ...
    for (int i = 0; i < notes1.getNoteTxsCount(); i++) {
      ...
      outPointBuild.setHash(ByteString.copyFrom(symId));
    ...
    for (int i = 0; i < 1; i++) {
      org.kcoin.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.kcoin.keystore.Wallet.generateRandomBytes(512);
  ...
  public void decodePaymentAddressIgnoreCase() {
    String addressLower =
        "zkcoin1975m0wyg8f30cgf2l5fgndhzqzkzgkgnxge8cwx2wr7m3q7chsuwewh2e6u24yykum0hq8ue99u";
