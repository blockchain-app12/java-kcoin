...
public class AccountVoteWitnessTest {
  ...
  private List<AccountCapsule> getAccountList() {
    ...
    final AccountCapsule accountKcoin =
        new AccountCapsule(
            ByteString.copyFrom("00000000001".getBytes()),
            ByteString.copyFromUtf8("Kcoin"),
            AccountType.Normal);
    ...
    final AccountCapsule accountVivider =
        new AccountCapsule(
            ...
            AccountType.Normal);
    // accountKcoin addVotes
    accountKcoin.addVotes(accountMarcus.getAddress(), 100);
    accountKcoin.addVotes(accountOlivier.getAddress(), 100);
    accountKcoin.addVotes(accountSasaXie.getAddress(), 100);
    accountKcoin.addVotes(accountVivider.getAddress(), 100);

    // accountMarcus addVotes
    accountMarcus.addVotes(accountKcoin.getAddress(), 100);
    ...
    accountOlivier.addVotes(accountKcoin.getAddress(), 100);
    ...
    accountCapsuleList.add(accountKcoin);
  ...
  private List<WitnessCapsule> getWitnessList() {
    ...
    final WitnessCapsule witnessKcoin =
    ...
    witnessCapsuleList.add(witnessKcoin);
