...
import stest.kcoin.wallet.common.client.utils.PublicMethedForMutiSign;
import stest.kcoin.wallet.common.client.utils.Retry;
import stest.kcoin.wallet.common.client.utils.Sha256Hash;
...
public class TransactionFee001 {
  ...
  Long beforeBurnSymAmount = 0L;
  Long afterBurnSymAmount = 0L;
  String txid = null;
  ...
  public void test01DeployContractEnergyFeeToSr() {
    ...
    beforeBurnSymAmount = blockingStubFull
        .getBurnSym(EmptyMessage.newBuilder().build()).getNum();
    ...
    afterBurnSymAmount = blockingStubFull
        .getBurnSym(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertEquals(beforeBurnSymAmount,afterBurnSymAmount);
  }
  ...
  public void test02UpdateAccountPermissionAndMultiSiginTrans() {
    ...
    afterBurnSymAmount = blockingStubFull
        .getBurnSym(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnSymAmount - beforeBurnSymAmount == 100000000L);
    ...
    afterBurnSymAmount = blockingStubFull
        .getBurnSym(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnSymAmount - beforeBurnSymAmount == 1000000L);
  }
  ...
  public void test03OutOfTimeEnergyFeeToBlackHole() {
    ...
    afterBurnSymAmount = blockingStubFull
        .getBurnSym(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnSymAmount - beforeBurnSymAmount == maxFeeLimit);
  }
  ...
  public void test04AccountCreate() {
    ...
    afterBurnSymAmount = blockingStubFull
        .getBurnSym(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnSymAmount - beforeBurnSymAmount == 100000L);
  }
  ...
  public void test06CreateAssetIssue() {
    ...
    afterBurnSymAmount = blockingStubFull
        .getBurnSym(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnSymAmount - beforeBurnSymAmount == 1024000000L);
  ...
  @Test(enabled = true, description = "Test getburnsym api from solidity or pbft")
  public void test07GetBurnSymFromSolidityOrPbft() {
    PublicMethed.waitSolidityNodeSynFullNodeData(blockingStubFull,blockingStubSolidity);
    Assert.assertEquals(blockingStubFull
        .getBurnSym(EmptyMessage.newBuilder().build()),blockingStubSolidity.getBurnSym(
        EmptyMessage.newBuilder().build()));
    Assert.assertEquals(blockingStubFull.getBurnSym(EmptyMessage.newBuilder().build()),
        blockingStubPbft.getBurnSym(
            EmptyMessage.newBuilder().build()));
  }
  /**
   * constructor.
