...
public class WalletTestAssetIssue007 {
  ...
  private static final Integer symNum = 1;
  ...
  public void testParticipateAssetIssueUseParticipateBandwidth() {
    ...
    Assert.assertTrue(PublicMethed
        .createAssetIssue(asset007Address, name, totalSupply, symNum, icoNum, start, end, 1,
    ...
    Assert.assertTrue(beforeBalance - symNum * 1 * icoNum >= afterBalance);
  }
