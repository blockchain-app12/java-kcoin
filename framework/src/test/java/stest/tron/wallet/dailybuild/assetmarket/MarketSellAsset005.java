package stest.kcoin.wallet.dailybuild.assetmarket;
...
public class MarketSellAsset005 {
  ...
  byte [] sym = ByteArray.fromString("_");
  ...
  @Test(enabled = true,description = "Create an order to sell Sym and buy Trc10")
  void test01SellSymBuyTrc10() {
    ...
    String txid = PublicMethed.marketSellAsset(testAddress002,testKey002,sym,
    ...
    txid = PublicMethed.marketSellAsset(testAddress001, testKey001, assetAccountId001,
            sellTokenQuantity * 2,
            sym, buyTokenQuantity * 2, blockingStubFull);
  ...
  @Test(enabled = true,description = "Create an order to sell Trc10 and buy Sym")
  void test02SellTrc10BuySym() {
    long balanceAfter = PublicMethed.queryAccount(testKey001, blockingStubFull).getBalance();
    ...
    txid = PublicMethed.marketSellAsset(testAddress001, testKey001, sym,
            sellTokenQuantity * 2,
