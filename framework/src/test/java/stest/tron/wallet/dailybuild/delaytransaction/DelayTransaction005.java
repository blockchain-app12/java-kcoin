package stest.kcoin.wallet.dailybuild.delaytransaction;
...
public class DelayTransaction005 {
  ...
  public void test1DelayUpdateSetting() {
    ...
    String contractName = "KCOINTOKEN";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractScenario004_deployErc20KcoinToken");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractScenario004_deployErc20KcoinToken");
