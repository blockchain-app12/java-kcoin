...
public class HttpTestAccount002 {
   ...
   * constructor.
   */
  @Test(enabled = true, description = "FreezeBlance for kcoin power by http")
  public void test015FreezeKcoinPower() {
    HttpMethed.waitToProduceOneBlock(httpnode);
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
   ...
   * constructor.
   */
  @Test(enabled = true, description = "UnFreezeBalance for kcoin power by http")
  public void test016UnFreezeBalanceForKcoinPower() {
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
