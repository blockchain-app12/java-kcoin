...
public class HttpTestMarket001 {
   ...
   * constructor.
   */
  @Test(enabled = true, description = "MarketSellAsset sym with trc10 by http")
   ...
   * constructor.
   */
  @Test(enabled = true, description = "MarketCancelOrder sym with trc10 by http")
