package stest.kcoin.wallet.dailybuild.manual;
...
public class ContractScenario002 {
  ...
  @Test(enabled = true, description = "Deploy contract with java-kcoin support interface")
  public void test01DeployKcoinNative() {
    ECKey ecKey1 = new ECKey(Utils.getRandom());
    byte[] contract002Address = ecKey1.getAddress();
    String contract002Key = ByteArray.toHexString(ecKey1.getPrivKeyBytes());
    ...
    String contractName = "KcoinNative";
