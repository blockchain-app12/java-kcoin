...
public class ContractScenario015 {
  ...
  @Test(enabled = true, description = "KCOIN TRC20 transfer token")
  public void trc20Kcoin() {
    ...
    String contractName = "KCOIN TRC20";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_Scenario015_TRC20_KCOIN");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_Scenario015_TRC20_KCOIN");
