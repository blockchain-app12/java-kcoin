package stest.kcoin.wallet.dailybuild.tvmnewcommand.newGrammar;
...
import org.kcoin.protos.contract.SmartContractOuterClass;
...
public class NewFeatureForSolc080 {
  ...
  @Test(enabled = true, description = "transfer sym to tx.origin address with payable")
  ...
  @Test(enabled = true, description = "transfer sym to literal address with payable")
