package stest.kcoin.wallet.dailybuild.tvmnewcommand.transferfailed;

import static org.kcoin.protos.Protocol.TransactionInfo.code.FAILED;
...
import stest.kcoin.wallet.common.client.utils.Base58;
...
public class TransferFailed001 {
  ...
  @Test(enabled = true, description = "Transfer sym insufficient balance")
  public void test001TransferSymInsufficientBalance() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferSymInsufficientBalance(uint256)", num, false,
  ...
  @Test(enabled = true, description = "Transfer sym nonexistent target")
  public void test003TransferSymNonexistentTarget() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferSymNonexistentTarget(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
    ...
    Assert.assertEquals(energyUsageTotal2 + EnergyCost.getInstance().getNewAcctCall(),
        energyUsageTotal);

  }


  @Test(enabled = true, description = "Transfer sym to myself")
  public void test004TransferSymSelf() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferSymSelf(uint256)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
    ...
    Assert.assertEquals("transfer sym failed: Cannot transfer SYM to yourself.",
        ByteArray.toStr(infoById.get().getResMessage().toByteArray()));
  ...
  @Test(enabled = true, description = "Transfer sym nonexistent target and insufficient balance")
  public void test005TransferSymNonexistentTarget() {
  ...
  @Test(enabled = true, description = "Transfer sym to myself and insufficient balance")
  public void test006TransferSymSelf() {
  ...
  @Test(enabled = true, description = "transferSym to nonexistent target ,but revert")
  public void test010TransferRevert() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferSymrevert(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
