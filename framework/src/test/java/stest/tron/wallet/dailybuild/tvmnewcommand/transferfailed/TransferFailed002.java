...
public class TransferFailed002 {
  ...
  public void test1SendNotEnough() {
    ...
    String num = "3000001";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendSymInsufficientBalance(uint256)", num, false, 0,
  ...
  @Test(enabled = true, description = "Send sym nonexistent target")
  public void test3SendSymNonexistentTarget() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendSymNonexistentTarget(uint256,address)", num,
  ...
  @Test(enabled = true, description = "Send sym self")
  public void test4SendSymSelf() {
    Account info;
    ...
    String num = "1";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendSymSelf(uint256)", num, false, 0, maxFeeLimit,
  ...
  @Test(enabled = true, description = "Send sym nonexistent target and balance not enough")
  public void test5SendSymNonexistentTarget() {
    Account info;
  ...
  @Test(enabled = true, description = "Send sym self and balance not enough")
  public void test6SendSymSelf() {
    Account info;
  ...
  @Test(enabled = true, description = "Send sym nonexistent target, but revert")
  public void test7SendSymNonexistentTargetRevert() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendSymRevert(uint256,address)", num, false, 0,
            maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
