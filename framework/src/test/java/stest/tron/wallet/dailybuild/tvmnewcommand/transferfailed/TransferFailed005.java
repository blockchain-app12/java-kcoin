...
public class TransferFailed005 {
  ...
  public void triggerContract01() {
    ...
    // transfer sym to self`s account
    String param = "\"" + paramValue + "\",\"" + Base58.encode58Check(contractAddress) + "\"";
    String triggerTxid = PublicMethed
        .triggerContract(contractAddress, "testCallSymInsufficientBalance(uint256,address)", param,
    ...
    // transfer sym to unactivate account
    ...
    // transfer sym to caller, value enough , function success contractResult(call_value) successed
    ...
    // transfer sym to caller, value not enough, function success
  ...
  public void triggerContract02() {
    ...
    String triggerTxid = PublicMethed
        .triggerContract(contractAddress, "testCreateSymInsufficientBalance(uint256)", param, false,
  ...
  public void triggerContract04() {
    ...
    TransactionExtention return1 = PublicMethed.triggerConstantContractForExtention(contractAddress,
        "testTransferSymInsufficientBalance(uint256)", "1", false, 0L, 1000000000, "0", 0L,
        accountExcAddress, accountExcKey, blockingStubFull);
    Assert.assertEquals(response_code.SUCCESS, return1.getResult().getCode());
    /*Assert.assertEquals(
        "class org.kcoin.core.vm.program.Program$StaticCallModificationException "
