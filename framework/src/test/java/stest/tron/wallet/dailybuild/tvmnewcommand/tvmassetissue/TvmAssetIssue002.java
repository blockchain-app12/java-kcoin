package stest.kcoin.wallet.dailybuild.tvmnewcommand.tvmassetissue;
...
public class TvmAssetIssue002 {
  ...
  public void tokenIssue001IllegalParameterVerification() {
    ...
    // assetName is sym
    String tokenName = PublicMethed.stringToHexString("sym");
    ...
    // totalSupply is -1
    tokenName = PublicMethed.stringToHexString(name);
    tokenAbbr = PublicMethed.stringToHexString("sym");
    param =
    ...
    Assert.assertEquals("sym", ByteArray.toStr(assetIssueById.getAbbr().toByteArray()));
    assetV2Map = PublicMethed.queryAccount(contractAddress, blockingStubFull)
        .getAssetV2Map();
  ...
  @Test(enabled = false, description = "tokenIssue sym balance insufficient")
  public void tokenIssue002SymBalanceInsufficient() {
    Assert.assertTrue(PublicMethed
        .sendcoin(dev001Address, 3100_000_000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "./src/test/resources/soliditycode/tvmAssetIssue001.sol";
