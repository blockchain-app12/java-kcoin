...
public class StackSuicideTest001 {
  ...
  @Test(enabled = false, description = "targetAddress no SYM, and no frozen")
  ...
  @Test(enabled = false, description = "targetAddress has SYM, but no frozen")
  ...
  @Test(enabled = false, description = "targetAddress has SYM, and has frozen")
