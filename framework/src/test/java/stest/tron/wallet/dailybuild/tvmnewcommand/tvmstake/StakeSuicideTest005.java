package stest.kcoin.wallet.dailybuild.tvmnewcommand.tvmstake;
...
import stest.kcoin.wallet.common.client.Parameter;
...
public class StakeSuicideTest005 {
  ...
  @Test(enabled = false, description = "targetAddress is account no SYM, and no frozen")
  ...
  @Test(enabled = false, description = "targetAddress is account 1 SYM, and no frozen")
  ...
  @Test(enabled = false, description = "targetAddress is account 1 SYM, and 1 frozen")
