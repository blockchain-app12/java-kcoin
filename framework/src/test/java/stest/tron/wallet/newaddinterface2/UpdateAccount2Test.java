package stest.kcoin.wallet.newaddinterface2;
...
//import stest.kcoin.wallet.common.client.AccountComparator;
...
public class UpdateAccount2Test {
  ...
  String url = "https://github.com/kcoinprotocol/wallet-cli/";
  ...
  @Test(enabled = true)
  public void testNoBalanceTransferSym2() {
  ...
  public Boolean createAssetIssue(byte[] address, String name, Long totalSupply, Integer symNum,
