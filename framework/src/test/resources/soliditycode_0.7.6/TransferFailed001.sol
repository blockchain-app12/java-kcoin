contract EnergyOfTransferFailedTest {
    ...
    function testCallSymInsufficientBalance(uint256 i,address payable caller) public {
    ...
    function testSendSymNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
    }

    function testSendSymRevert(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
        revert();
    }

    function testTransferSymNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.transfer(i);
    }

    function testTransferSymrevert(uint256 i,address payable nonexistentTarget) payable public{
        nonexistentTarget.transfer(i);
        revert();
    }
    ...
    function testCallSymNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
